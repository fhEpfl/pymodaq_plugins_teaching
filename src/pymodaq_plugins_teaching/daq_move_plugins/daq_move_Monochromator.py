...
class DAQ_Move_Monochromator(DAQ_Move_base):
    ...
    _controller_units: Union[str] = 'nm'  # TODO for your plugin: put the correct unit here, it could be
    ...
    def get_actuator_value(self)->DataActuator:
        ...
        wavelength = DataActuator(data=self.controller.get_wavelength(), units=self.axis_unit)
        wavelength = self.get_position_with_scaling(wavelength)
        return wavelength
    ...
    def move_abs(self, value: DataActuator):
        ...
        self.emit_status(ThreadCommand('Update_Status', [f'Controller moved to {value}']))
    ...
    def move_rel(self, value: DataActuator):
        ...
        """
        value = self.check_bound(self.get_actuator_value() + value) - self.current_position
